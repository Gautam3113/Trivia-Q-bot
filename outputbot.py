...
def update_embed():
    ...
    if data.embed is None:
        data.embed = discord.Embed(title='**__CONFETTI TRIVIA__**', color=0x89cff0)
        ...
        data.embed.set_footer(text= 'Trvia-Qbot')

        data.embed_best = discord.Embed(title='**__CONFETTI TRIVIA__**', color=0x89cff0)
